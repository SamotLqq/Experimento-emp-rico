...
// haremos la funcion sabiendo que el arreglo de movimientos esta ordenado pues los movimientos
// se pushean en orden hacendente, tambien consideramos que el formato de las variables desde
// y hasta es el siguiente. numDia-numMes-numAño

export function movimientos(e, dniAdmin, claveAdmin, dni, desde, hasta){
  // imprime los movimientos del usuario si existen
